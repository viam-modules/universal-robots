            ...
            .inputs =
                {
                    {.name = "waypoints",
                     ...
                     .associated_files = {},
                     .extra = {}},
                    {.name = "waypoint_deduplication_tolerance_deg",
                     .description = "Waypoint deduplication tolerance in degrees [scalar]",
                     .data_type = tensor_info::data_types::k_float64,
                     .shape = {1},
                     .associated_files = {},
                     .extra = {}},
                    {.name = "path_tolerance_delta_deg",
                     .description = "Path tolerance delta in degrees [scalar]",
                     .data_type = tensor_info::data_types::k_float64,
                     .shape = {1},
                     .associated_files = {},
                     .extra = {}},
