...
///
inline bool within_colinearization_tolerance(const Eigen::VectorXd& point,
...
///
inline void apply_colinearization(std::list<Eigen::VectorXd>& waypoints, double tolerance) {
